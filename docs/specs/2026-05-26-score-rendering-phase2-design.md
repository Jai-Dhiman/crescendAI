...
- **Canonical success state:**
  1. `scoreRenderer.load('chopin-ballade-op23-no1')` resolves under 200ms wall-clock with non-null `ir` and `pageSvgs.length === ir.pages.length`.
