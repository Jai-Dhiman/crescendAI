...
# ---------------------------------------------------------------------------
SHORTLIST_MODE: str = "whole_piece"      # "whole_piece" | "windowed"
WINDOW_NOTES: int = 200
WINDOW_HOP: int = 100
TOP_K: int = 5
MARGIN_THRESHOLD: float = 0.13
ABS_COST_FLOOR: float | None = None
AMT_SOURCE_EXTRA_MARGIN: float = 0.0
