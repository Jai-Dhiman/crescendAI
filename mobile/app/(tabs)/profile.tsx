...
export default function ProfileScreen() {
  ...
  const { settings, updateNotificationSettings, updateAudioSettings, resetSettings } = useSettingsStore();
...
Redirect URI: ${config.redirectUri}`,
  ...
  const toggleSetting = (section: 'notifications' | 'audio', key: string, currentValue: boolean) => {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.section}>
        ...
        {renderToggleItem(
          ...
          () => toggleSetting('notifications', 'practiceReminders', settings.notifications.practiceReminders)
        )}
        ...
        {renderToggleItem(
          ...
          () => toggleSetting('notifications', 'analysisComplete', settings.notifications.analysisComplete)
        )}
        ...
        {renderToggleItem(
          ...
          () => toggleSetting('notifications', 'weeklyReports', settings.notifications.weeklyReports)
        )}
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingItem}>
          ...
          <Text style={styles.settingValue}>{settings.audio.sampleRate} Hz</Text>
        </View>
        ...
        <View style={styles.settingItem}>
          ...
          <Text style={styles.settingValue}>{settings.audio.format.toUpperCase()}</Text>
        </View>
      </View>
      ...
      <View style={styles.version}>
        <Text style={styles.versionText}>Piano Performance Analyzer v1.0.0</Text>
