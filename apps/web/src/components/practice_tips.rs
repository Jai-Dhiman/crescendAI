        ...
        <div class="card p-6">
            ...
            <ul class="space-y-4" role="list">
                {tips.into_iter().enumerate().map(|(i, tip)| {
                    view! {
                        <li class="flex gap-4">
                            <div class="flex-shrink-0 w-6 h-6 rounded-md bg-sepia-100 flex items-center justify-center">
                                <span class="text-label-sm font-medium text-sepia-700">
                                    {i + 1}
                                </span>
                            </div>
                            <div class="flex-1 min-w-0">
                                <h4 class="font-medium text-body-md text-ink-800 mb-0.5">
                                    {tip.title}
                                </h4>
