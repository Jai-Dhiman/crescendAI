...
/// A piano performance available for analysis.
/// This struct must match the frontend's Performance model exactly.
...
impl Performance {
    /// Returns the curated list of demo performances.
    /// These match the frontend's mock data for consistency.
