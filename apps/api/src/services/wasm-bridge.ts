...
type ScoreAnalysisMod =
	typeof import("../wasm/score-analysis/pkg/score_analysis");
// eslint-disable-next-line @typescript-eslint/consistent-type-imports
type PieceIdentifyMod =
	typeof import("../wasm/piece-identify/pkg/piece_identify");

const scoreAnalysisModule: ScoreAnalysisMod | null = null;
const pieceIdentifyModule: PieceIdentifyMod | null = null;
...
export function rerankCandidates(
	...
	return requirePieceIdentify().rerank_candidates(
		notes,
		candidates,
		features,
	) as RerankResult[];
...
export function dtwConfirm(
	...
	return requirePieceIdentify().dtw_confirm(
		perfNotes,
		scoreNotes,
		threshold,
	) as DtwConfirmResult;
