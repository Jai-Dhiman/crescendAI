...
from paths import MODEL_DATA, PROJECT_ROOT

RECORDINGS_JSONL = MODEL_DATA / "intermediate_cache" / "recordings.jsonl"
AUDIO_DIR = MODEL_DATA / "eval" / "youtube_amt"
CACHE_DIR = MODEL_DATA / "eval" / "inference_cache"
TRACES_DIR = MODEL_DATA / "eval" / "traces"
